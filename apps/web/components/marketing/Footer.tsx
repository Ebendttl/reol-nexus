      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4 pt-2">
            <a href="#" className="p-2 rounded-lg bg-[#1E2720] hover:bg-[#0F5132] text-[#90A496] hover:text-white transition-all" aria-label="Instagram">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
            </a>
            <a href="#" className="p-2 rounded-lg bg-[#1E2720] hover:bg-[#0F5132] text-[#90A496] hover:text-white transition-all" aria-label="Facebook">
            ...
            <a href="#" className="p-2 rounded-lg bg-[#1E2720] hover:bg-[#0F5132] text-[#90A496] hover:text-white transition-all" aria-label="Twitter">
